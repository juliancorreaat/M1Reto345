...
//import org.springframework.boot.autoconfigure.data.redis.GamaResourcesBuilderCustomizer;
...
@Service
public class GamaService {    // Es una clase que se encarga de las funcionalidades del negocio
